...
import { KawaseBlurFilter } from 'dist/@pixi/filter-kawase-blur';
import SimplexNoise from 'dist/simplex-noise';
import hsl from 'dist/hsl-to-hex';
...
class ColorPalette {
  ...
  setColors() {
    ...
    this.complimentaryColor2 = hsl(27, 85, 58);
